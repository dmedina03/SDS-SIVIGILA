...
namespace SIVIGILA.Controllers
{
    ...
    public class TipoDocumentoController : ControllerBase
    {
        ...
        [HttpGet("Search")]
        public async Task<IActionResult> GetByParamsAsync([FromQuery] SearchBaseTipoDocumentoDTO Dto)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync(TipoDocumentoDTO Dto)
        {
            return Ok(GetDefaultResponse(await _service.AddAsync(Dto)));
        }
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateAsync([FromRoute] int id, TipoDocumentoDTO Dto)
        {
            Dto.TipoDocumentoID = id;
            return Ok(GetDefaultResponse(await _service.UpdateAsync(Dto)));
        }
        [HttpPost("Range")]
        public async Task<IActionResult> CreateOrUpdateRangeAsync(IEnumerable<TipoDocumentoDTO> lista)
        {
